...
(function () {
    ...
    function onReady() {
        const mainButtonSelectorSet = new Set(['#content > div > div.oe-layout-main > div > div:nth-child(2) > div > div > div > div.panel-body > div:nth-child(12) > div > span.field_item_value > span > span > button'])
        ...
        function clickConfirmation() {
            ...
            for (let i = 6; i <= 20; i++) {
                confirmSelectorSet.add(`body > div:nth-child(${i}) > div > div.ant-modal-wrap > div > div.ant-modal-content > div > div > div.ant-confirm-btns > button.ant-btn.ant-btn-primary.ant-btn-lg`)
            }
